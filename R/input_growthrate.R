...
get_input <- function(age0 = 40,
  ...
  input$agent$l_inc_betas <- t(as.matrix(c(intercept = -3.55-input$global_parameters$closed_cohort*100, y = 0.005, y2 = 0))) # intercept is the result of model calibration,
